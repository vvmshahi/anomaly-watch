...
export const SensitivitySlider = ({ value, onChange }: SensitivitySliderProps) => {
  ...
  return (
    <div className="flex items-center space-x-6 bg-gradient-to-r from-gray-50 to-white rounded-xl p-6 border border-gray-200/50 shadow-sm">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative">
          <input
            ...
            className="w-40 h-3 bg-gradient-to-r from-red-200 via-orange-200 via-yellow-200 to-green-200 rounded-lg appearance-none cursor-pointer slider"
            style={{
      ...
      <div className="flex items-center space-x-4">
        ...
        <span className={`text-lg font-bold ${getSensitivityColor(value)} bg-white px-3 py-1 rounded-lg border border-current/20 shadow-sm`}>
